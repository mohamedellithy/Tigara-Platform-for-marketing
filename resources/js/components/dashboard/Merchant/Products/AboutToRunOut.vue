        ...
        <div class="row filter-bar">
            <div class="col-md-8">
                <ul class="filter-results">
                    ...
                    <li class="filter-item">
                        <i class="fas fa-user-check"></i>
                        {{  about_to_out_products  }} كل منتجات أوشكت على النفاذ
                    </li>
                </ul>
            </div>
            <div class="col-md-4">
...
export default {
    ...
    methods:{
        FetchProducts:function(){
            let self = this;
            axios.get('/api/about-to-out-products',{
                params:self.params
            }).then(function({data}){
                console.log(data);
                self.infos              = data.data_info;
                self.products           = self.infos.data;
                self.about_to_out_products  = data.about_to_out_products;
