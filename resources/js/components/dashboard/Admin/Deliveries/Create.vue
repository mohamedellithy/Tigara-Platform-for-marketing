<template>
    <div class="container-body-merchant">
        <form method="post" @submit.prevent="CreateNewDelivery">
            <div class="row">
                ...
                <div class="col-md-6 container-submit-btn-merchant">
                    <button type="submit" class="btn btn-success">
                        ...
                        اضافة شركة الشحن مفعلا
                    </button>
                    <button type="button" @click="CreateNewDraftDelivery" value="0" class="btn btn-danger">
                        <i class="fas fa-user-slash"></i>
                         اضافة شركة الشحن غير مفعل
                    </button>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 container-form-new-merchant">
                    <div class="form-group">
                        ...
                        <input id="merchant-name" placeholder="اسم شركة الشحن" class="form-control" type="text" v-model="field.name"/>
                    </div>
                    <div class="form-group">
                        <label for="merchant-name">
                            <i class="fas fa-user-edit" style="padding: 5px;"></i>
