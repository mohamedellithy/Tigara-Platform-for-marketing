    ...
    <div class="container">
        ...
        <div class="row">
            <div style="width:30%" class="form-group">
                <select class="form-control" v-model="filter_products">
                    <option value="">فلترة المنتجات</option>
                    <option value="1">المنتجات الأكثر طلبا</option>
                    <option value="2">المنتجات الأقل طلبا</option>
                </select>
            </div>
