<template>
    <div>
        ...
        <li class="list-items-menu">
            <router-link
                tag="a"
                @click="toggleListMenuSidebar('delivery-reports')"
                class="item-menu active"
                active-class="active"
                :to="{ name: 'delivery-reports' }"
                exact>
                 <i class="fas fa-tachometer-alt"></i>
                <label>لوحة الرئيسية</label>
                <i
                    class="fas fa-chevron-down chevron"
                    v-show="this.expanded.indexOf('delivery-reports') !== 0"
                ></i>
                <i
            ...
            <ul
                :class="`child-list-items-menu ${
                    this.expanded.indexOf('delivery-reports') !== 0 ? 'active' : ''
                }`"
            >
                <li class="li-child-list-items-menu">
                    <router-link class="a-child-list-item-menu" active-class="active" :to="{name:'delivery-reports'}" exact>
                        <i class="fas fa-tachometer-alt"></i>
                        <label>لوحة الرئيسية</label>
                    </router-link>
                </li>
        ...
        <li class="list-items-menu">
            <router-link
                tag="a"
                @click="toggleListMenuSidebar('show-due-delivery-payments')"
                class="item-menu active"
                active-class="active"
                ...
                <i
                    class="fas fa-chevron-down chevron"
                    v-show="this.expanded.indexOf('show-due-delivery-payments') !== 0"
                ></i>
                <i
                    class="fas fa-chevron-up chevron"
                    v-show="this.expanded.indexOf('show-due-delivery-payments') === 0"
            ...
            <ul
                :class="`child-list-items-menu ${
                    this.expanded.indexOf('show-due-delivery-payments') !== 0 ? 'active' : ''
                }`"
            >
                <li class="li-child-list-items-menu">
