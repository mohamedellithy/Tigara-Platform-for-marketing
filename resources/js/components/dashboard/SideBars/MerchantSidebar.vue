<template>
    <div>
        ...
        <li class="list-items-menu">
            <router-link
                tag="a"
                @click="toggleListMenuSidebar('merchant-reports')"
                ...
                <i
                    ...
                    v-show="this.expanded.indexOf('merchant-reports') !== 0"
                ></i>
                <i
            ...
            <ul
                :class="`child-list-items-menu ${
                    this.expanded.indexOf('merchant-reports') !== 0 ? 'active' : ''
                }`"
            >
                <li class="li-child-list-items-menu">
                    <router-link class="a-child-list-item-menu" active-class="active" :to="{name:'merchant-reports'}" exact>
                        <i class="fas fa-tachometer-alt"></i>
                        <label>لوحة الرئيسية</label>
                    </router-link>
                </li>
        ...
        <li class="list-items-menu">
            <router-link
                tag="a"
                @click="toggleListMenuSidebar('merchant-products')"
                class="item-menu active"
                active-class="active"
                ...
                <i
                    class="fas fa-chevron-down chevron"
                    v-show="this.expanded.indexOf('merchant-products') !== 0"
                ></i>
                <i
                    class="fas fa-chevron-up chevron"
                    v-show="this.expanded.indexOf('merchant-products') === 0"
            ...
            <ul
                :class="`child-list-items-menu ${
                    this.expanded.indexOf('merchant-products') !== 0 ? 'active' : ''
                }`"
            >
                <li class="li-child-list-items-menu">
